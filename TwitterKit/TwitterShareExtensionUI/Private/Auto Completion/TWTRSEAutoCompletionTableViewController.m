...
- (instancetype)initWithAutoCompletion:(id<TWTRSEAutoCompletion>)autoCompletion
                       imageDownloader:(id<TWTRSEImageDownloader>)imageDownloader
                              delegate:(nonnull id<TWTRSEAutoCompletionTableViewControllerDelegate>)delegate
{
    ...
    if ((self = [super initWithNibName:nil bundle:nil])) {
        ...
        _wordAroundSelectionProperty = [[TWTRSEThrottledProperty alloc] initWithThottleInterval:kAutoCompletionTypingThrottleInterval
                                                                                       observer:self];
