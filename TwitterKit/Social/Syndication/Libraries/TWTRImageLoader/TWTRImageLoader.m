 ...
 */
- (void)fetchCachedImageWithImageKey:(NSString *)imageKey
                  cacheHitCompletion:(TWTRImageLoaderFetchCompletion)cacheHitCompletion
                 cacheMissCompletion:(void (^)(void))cacheMissCompletion
{
